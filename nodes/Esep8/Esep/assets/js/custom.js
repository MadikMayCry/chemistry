...
$("#01").data("number", 1 || 2 || 3).draggable(optDraggable);
$("#02").data("number", 1 || 2 || 3).draggable(optDraggable);
$("#03").data("number", 1 || 2 || 3).draggable(optDraggable);
$("#04").data("number", 4).draggable(optDraggable);
$("#05").data("number", 5).draggable(optDraggable);

$("#ans01").data("number", 1 || 2 || 3).droppable(optDroppable);
$("#ans02").data("number", 1 || 2 || 3).droppable(optDroppable);
$("#ans03").data("number", 1 || 2 || 3).droppable(optDroppable);
