    ...
    $("#06").data("number", 6 || 8).draggable(optDraggable);
    $("#07").data("number", 7).draggable(optDraggable);
    $("#08").data("number", 6 || 8).draggable(optDraggable);
    ...
    $("#ans06").data("number", 6 || 8).droppable(optDroppable);
    $("#ans07").data("number", 7).droppable(optDroppable);
    $("#ans08").data("number", 6 || 8).droppable(optDroppable);
